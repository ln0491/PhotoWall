package com.liu.photowall.view;
...
import com.liu.photowall.adapter.PopuAdapter;
import com.liu.photowall.bean.PhotoFolder;

import java.util.List;

/**
 * Created by 刘楠 on 2016/9/3 0003.15:53
 */
public class PopuListImageWindow extends PopupWindow {
    Context mContext;
    ...
    public PopuListImageWindow(Context context, List<PhotoFolder> datas){
        super(context);
